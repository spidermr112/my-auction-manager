...
def init_db():
    ...
    check_cols = {
        "request_goal": "TEXT", "room_count": "TEXT", "bath_count": "TEXT", 
        "receipt_date": "TEXT", "deposit": "INTEGER", "monthly_rent": "INTEGER", 
        "converted_deposit": "INTEGER"
    }
...
with st.sidebar:
    ...
    goals = st.multiselect("의뢰목적 (복수 선택 가능)", goal_options)
