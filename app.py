...
# 서비스 계정 정보 (내용은 동일하지만 처리 방식을 개선합니다)
...
# --- [2. 앱 UI 구성] ---
st.set_page_config(page_title="부동산 매물 관리", page_icon="🏢", layout="wide")
st.title("🏢 부동산 매물 관리 시스템")
...
# --- [4. 목록 섹션] ---
df_display = st.session_state.df_list
